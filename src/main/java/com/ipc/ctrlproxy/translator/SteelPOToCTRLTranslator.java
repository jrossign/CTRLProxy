...
public class SteelPOToCTRLTranslator implements Translator
{
    ...
    public Header getCTRLHeader(SPOrder order, String  action) throws ParseException
    {
        ...
        return Header.builder()
                ...
                .compagnieSource(StringUtils.leftPad(order.getPurchasingOrganization(), 3, '0'))
                .compagnieDestination(StringUtils.leftPad(order.getPurchasingOrganization(), 3, '0'))
                .compagnieLiee("001")
    ...
    public List<Details> getCTRLDetails(SPOrder order, String  action) {
        ...
        for (Item item : order.getItems()) {
            ...
            list.add(Details.builder()
                    ...
                    .compagnie(StringUtils.leftPad(order.getPurchasingOrganization(), 3, '0'))
